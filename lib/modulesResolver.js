...
/*
  endpoint: { name source target } ... info about the app ...
  canonicalDir: <cwd>
  pkgMeta: { name version dependencies:{..} }
  dependencies: {
    angular: { endpoint canonicalDir pkgMeta dependencies nrDependants }
    angular-route: { endpoint canonicalDir pkgMeta dependencies nrDependants }
  }
*/

function setBowerMap(map) {
  this.map = map;
  // console.info('Loaded bower modules');
  // console.info(map);
}
